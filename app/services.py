...
class Services:
    ...
    def show_dev_trans(self, word):
        word_tuples = self.repo.dev_query(word)
    ...
    def show_dev_trans_old(self, word:str) -> str:
        ...
        if self.word not in self.repo.dev_gloss():
            ...
            return self.repo.dev_query(self.word)[0][3] #return English portion of word entry

    # (ADDITIONAL) USE CASE 3 English Translation - user can input an English word and get Hindi translation(s).
    def show_eng_trans(self, word:str) -> str:
        ...
        if self.word not in self.repo.eng_gloss():
            ...
            return self.repo.eng_query(self.word)[0][1] #return Hindi portion of word entry
